...
(function(){
  ...
  function showUpdateBanner(){
    ...
    bar.style.cssText = 'position:fixed;left:12px;right:12px;bottom:14px;z-index:99999;'
      + 'background:#1a5c3a;color:#fff;border-radius:14px;padding:12px 14px 12px 16px;'
    ...
    bar.innerHTML = '<span style="flex:1">🔄 Ada pembaruan aplikasi.</span>'
      + '<button id="app-update-reload-btn" style="background:#fff;color:#1a5c3a;border:none;'
